 ...
 * @return void
 */
function chuchadon_custom_background_setup() {

	add_theme_support( 'custom-background',
		apply_filters( 'chuchadon_custom_background_args',
			array(
				'default-color'    => 'fafafa',
				'default-image'    => '',
				'wp-head-callback' => 'chuchadon_custom_background_callback'
			) 
		)
	);
}
add_action( 'after_setup_theme', 'chuchadon_custom_background_setup', 15 );
 ...
 * @return void
 */
function chuchadon_custom_background_callback() {
	...
	add_filter( 'body_class', 'chuchadon_add_custom_background_class' );
}
 ...
 * @return array
 */
function chuchadon_add_custom_background_class( $classes ) {
