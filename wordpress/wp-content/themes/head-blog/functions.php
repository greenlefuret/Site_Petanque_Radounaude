...
if ( !function_exists( 'head_blog_generate_construct_footer' ) ) :
	...
	function head_blog_generate_construct_footer() {
		...
		<p class="footer-credits-text text-center">
			<?php printf( __( 'Proudly powered by %s', 'head-blog' ), '<a href="' . esc_url( __( 'https://wordpress.org/', 'head-blog' ) ) . '">WordPress</a>' ); ?>
			<span class="sep"> | </span>
			<?php printf( __( 'Theme: %1$s', 'head-blog' ), '<a href="http://headthemes.com/">Head Blog</a>' ); ?>
		</p>
		<?php
	}
